"""
create separate table with only "charged leptons" in hdf5
...
if __name__=='__main__':
    with tables.open_file(FILENAME, 'a') as data:
        ...
        print "Will move /groundparticles to /all and copy only leptons to /groundparcticles"
        ...
        data.root.groundparticles.cols.x.create_csindex()
